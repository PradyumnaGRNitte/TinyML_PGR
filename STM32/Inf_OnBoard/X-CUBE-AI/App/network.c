...
#define AI_NETWORK_MODEL_SIGNATURE     "0x00177bf66787f228ea6e8f5ba719480d"
...
#define AI_TOOLS_DATE_TIME   "2026-07-30T15:38:15+0530"
...
/* Array#9 */
AI_ARRAY_OBJ_DECLARE(
  label_class_weights_array, AI_ARRAY_FORMAT_U8,
  NULL, NULL, 226930, AI_STATIC)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  3, 0x0,
  AI_SHAPE_INIT(4, 1, 226930, 1, 1), AI_STRIDE_INIT(4, 2, 2, 453860, 453860),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  5, 0x0,
  AI_SHAPE_INIT(4, 1, 226930, 1, 1), AI_STRIDE_INIT(4, 1, 1, 226930, 226930),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  9, 0x0,
  AI_SHAPE_INIT(4, 1, 90672, 1, 1), AI_STRIDE_INIT(4, 2, 2, 181344, 181344),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  10, 0x0,
  AI_SHAPE_INIT(4, 1, 90672, 1, 1), AI_STRIDE_INIT(4, 1, 1, 90672, 90672),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  12, 0x0,
  AI_SHAPE_INIT(4, 1, 90672, 1, 1), AI_STRIDE_INIT(4, 4, 4, 362688, 362688),
...
AI_LAYER_OBJ_DECLARE(
  ...
  .class_weights_scale = 3.921568539797091e-05, 
  .class_weights_offset = 0.0, 
)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 1951248, 1, 1),
    1951248, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    label_nodes_values_array.data = AI_PTR(g_network_weights_map[0] + 90772);
    label_nodes_values_array.data_start = AI_PTR(g_network_weights_map[0] + 90772);
    label_nodes_truenodeids_array.format |= AI_FMT_FLAG_CONST;
    label_nodes_truenodeids_array.data = AI_PTR(g_network_weights_map[0] + 453460);
    label_nodes_truenodeids_array.data_start = AI_PTR(g_network_weights_map[0] + 453460);
    label_nodes_falsenodeids_array.format |= AI_FMT_FLAG_CONST;
    label_nodes_falsenodeids_array.data = AI_PTR(g_network_weights_map[0] + 634804);
    label_nodes_falsenodeids_array.data_start = AI_PTR(g_network_weights_map[0] + 634804);
    label_class_weights_array.format |= AI_FMT_FLAG_CONST;
    label_class_weights_array.data = AI_PTR(g_network_weights_map[0] + 816148);
    label_class_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 816148);
    label_nb_node_by_estimator_array.format |= AI_FMT_FLAG_CONST;
    label_nb_node_by_estimator_array.data = AI_PTR(g_network_weights_map[0] + 1043080);
    label_nb_node_by_estimator_array.data_start = AI_PTR(g_network_weights_map[0] + 1043080);
    label_class_nodeids_array.format |= AI_FMT_FLAG_CONST;
    label_class_nodeids_array.data = AI_PTR(g_network_weights_map[0] + 1043280);
    label_class_nodeids_array.data_start = AI_PTR(g_network_weights_map[0] + 1043280);
    label_nb_class_by_estimator_array.format |= AI_FMT_FLAG_CONST;
    label_nb_class_by_estimator_array.data = AI_PTR(g_network_weights_map[0] + 1497140);
    label_nb_class_by_estimator_array.data_start = AI_PTR(g_network_weights_map[0] + 1497140);
    label_classlabels_int64s_array.format |= AI_FMT_FLAG_CONST;
    label_classlabels_int64s_array.data = AI_PTR(g_network_weights_map[0] + 1497340);
    label_classlabels_int64s_array.data_start = AI_PTR(g_network_weights_map[0] + 1497340);
    label_base_values_array.format |= AI_FMT_FLAG_CONST;
    label_base_values_array.data = AI_PTR(g_network_weights_map[0] + 1497360);
    label_base_values_array.data_start = AI_PTR(g_network_weights_map[0] + 1497360);
    label_class_ids_array.format |= AI_FMT_FLAG_CONST;
    label_class_ids_array.data = AI_PTR(g_network_weights_map[0] + 1497380);
    label_class_ids_array.data_start = AI_PTR(g_network_weights_map[0] + 1497380);
    output_probability_classlabels_ints_array.format |= AI_FMT_FLAG_CONST;
    output_probability_classlabels_ints_array.data = AI_PTR(g_network_weights_map[0] + 1951240);
    output_probability_classlabels_ints_array.data_start = AI_PTR(g_network_weights_map[0] + 1951240);
    return true;
  }
